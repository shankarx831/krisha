...
11: #include <vector>
12: #include <string>
13: #include "radioform_dsp.h"
14: 
15: static radioform_dsp_engine_t* g_dsp_engine = nullptr;
...
77: 
78:         float gain_db = radioform_dsp_get_magnitude_at_frequency(g_dsp_engine, g_frequencies[i], true);
...
99: 
100:         float gain_db = radioform_dsp_get_magnitude_at_frequency(g_dsp_engine, g_frequencies[i], false);
...
118:     if (g_dsp_engine) {
119:         radioform_dsp_update_preamp_left(g_dsp_engine, g_preamp_left);
120:     }
...
126:     if (g_dsp_engine) {
127:         radioform_dsp_update_preamp_right(g_dsp_engine, g_preamp_right);
128:     }
...
134:     if (g_dsp_engine) {
135:         radioform_dsp_set_bypass(g_dsp_engine, g_bypass);
136:     }
...
197:     g_dsp_engine = radioform_dsp_create(48000);
198:     if (g_dsp_engine) {
199:         radioform_preset_t preset;
200:         radioform_dsp_preset_init_flat(&preset);
201:         radioform_dsp_apply_preset(g_dsp_engine, &preset);
202:     }
203: 
204:     precompute_logarithmic_steps();
205: 
206:     GtkApplication* app = gtk_application_new("com.radioform.spoke.linux", G_APPLICATION_DEFAULT_FLAGS);
...
210: 
211:     if (g_dsp_engine) {
212:         radioform_dsp_destroy(g_dsp_engine);
213:     }
214:     return status;
215: }
216: 
